/**
 * Client-side API client for VelShop. Persists tokens to localStorage so
...
const ACCESS_KEY = 'velnox_shop_access_token';
const REFRESH_KEY = 'velnox_shop_refresh_token';
