import { ProfileImageUpload, UploadDebugPanel, type TraceStep } from "@/components/shop/ProfileImageUpload";
...
export default function ShopProfile() {
  ...
  const [uploadTrace, setUploadTrace] = useState<{ traceId: string; steps: TraceStep[]; lastOk: boolean; error?: string } | null>(null);
          ...
          <>
            ...
            <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white">
              ...
              <div className="px-5 pb-5">
                ...
                {/* Debug panel — only visible when an upload has occurred */}
                <UploadDebugPanel trace={uploadTrace} />
