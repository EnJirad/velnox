...
import { type GeoPoint, encodeGeoInText, stripGeoFromText, parseGeoFromText } from '@velnox/utils';
...
export function ProfileView() {
  ...
  function startEditAddress(a: AddressRow) {
    ...
    setAddressForm({
      name: a.name,
      phone: a.phone,
      addressLine: stripGeoFromText(a.addressLine),
      city: a.city,
      province: a.province,
    ...
    setAddressGeo(parseGeoFromText(a.addressLine));
  }
  ...
  async function handleSaveAddress() {
    ...
    try {
      const payload = {
        ...
        addressLine: encodeGeoInText(addressForm.addressLine.trim(), addressGeo),
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          ...
                          <p className="mt-1">
                            {stripGeoFromText(a.addressLine)} {a.city} {a.province} {a.postalCode}
                          </p>
                        </div>
