/**
 * Client-side API client for VelMerchant. Persists tokens to localStorage so
...
const ACCESS_KEY = 'velnox_merchant_access_token';
const REFRESH_KEY = 'velnox_merchant_refresh_token';
